...
public class InMemoryPromptBuilderService implements PromptBuilderService {
  final PromptTemplateStorage promptTemplateStorage = new PromptTemplateStorage(
    ...
    """
      ...
      * Укажи минимум 2 поднавыка в subskills. Поднавыки - минимальные обучаемые компоненты.
      ...
      * Важно:
          ...
          * Если для какого-то поля нет информации, используй пустой массив [] или пустую строку "" вместо null.
          * Указывай все properties и objects из "JSON Schema instance" (особенно subSkills и id).
